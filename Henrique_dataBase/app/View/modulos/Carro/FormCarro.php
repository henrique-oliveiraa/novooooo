            ...
            <div class="card-body">
                <form id="carForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="Marca" name="Marca" placeholder="Ex: Ford, Toyota, Honda"<?= $model->Marca ?> >
                    </div>
                    
                    <div class="mb-3">
                        <label for="inputName" class="form-label fw-semibold">Nome</label>
                        <input type="text" class="form-control" id="nomeCarro" name="nomeCarro" placeholder="Ex: Mustang, Corolla, Civic" <?= $model->Marca ?>>
                    </div>
                    
                    <div class="mb-3">
                        <label for="inputPrice" class="form-label fw-semibold">Quilometros</label>
                        <input type="text" class="form-control"id="Quilometros" name="Quilometros" placeholder="Ex: 120000" required>
                    </div>
